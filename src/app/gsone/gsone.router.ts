...
router.get(`${GET_FOTO_UPLOAD_URL_ENDPOINT}`, amimedController.getFotoUploadUrl);
router.post(`${CONFIRM_FOTO_VISITA_ENDPOINT}`, amimedController.confirmarFotoVisita);
router.get(`${GET_FOTOS_VISITA_ENDPOINT}`, amimedController.getFotosVisita);
router.delete(`${DEL_FOTO_VISITA_ENDPOINT}`, amimedController.delFotoVisita);