...
export interface PROVEEDORESBKAttributes {
  proveedor_id: string;
...
export type PROVEEDORESBKOptionalAttributes = "proveedor_dsc" | "gln" | "fechaSolicitud" | "CedJuridica" | "RazonSocial" | "RepreLegal" | "GerenteGeneral" | "GerenteVentas" | "AgenteVentas" | "ContactoFinanc" | "Direccion" | "canton_id" | "Barrio" | "Tel1" | "Tel2" | "NombreContactoFactElec" | "TelContactoFactElec" | "EmailContactoFactElec" | "EmailReciboContactoFactElec" | "CantidadLineasXFactura" | "TipoEntrega" | "AceptaDevoluc" | "OrdenCompra" | "DescuentoFijo" | "PorDescuentofijo" | "DescuentoConfidencial" | "PorcDescuentoConfidencial" | "DescuentoIntroduccion" | "PorcDescuentoIntroduccion" | "PartDinamicasComerciales" | "PartEspaciosPromocionales" | "PartDisplays" | "FrecuenciaVisitaTiendas" | "AportaCodigoCABYS" | "CodigoCABYS" | "ActividadEconomicaID" | "PlazoPagoID" | "DocEntregaFacElect" | "DocEntregaGuiaDespacho";
export type PROVEEDORESBKCreationAttributes = Optional<PROVEEDORESBKAttributes, PROVEEDORESBKOptionalAttributes>;

export class PROVEEDORESBK extends Model<PROVEEDORESBKAttributes, PROVEEDORESBKCreationAttributes> implements PROVEEDORESBKAttributes {
  proveedor_id!: string;
  proveedor_dsc?: string;
  gln?: string;
  fechaSolicitud?: Date;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof PROVEEDORESBK {
    return PROVEEDORESBK.init({
    proveedor_id: {
