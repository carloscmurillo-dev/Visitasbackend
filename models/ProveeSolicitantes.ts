...
export interface ProveeSolicitantesAttributes {
  proveedor_id: number;
...
export type ProveeSolicitantesPk = "proveedor_id";
export type ProveeSolicitantesId = ProveeSolicitantes[ProveeSolicitantesPk];
export type ProveeSolicitantesOptionalAttributes = "proveedor_id" | "proveedor_dsc" | "gln" | "categoria_id" | "fechaSolicitud" | "CedJuridica" | "RazonSocial" | "RepreLegal" | "GerenteGeneral" | "GerenteVentas" | "AgenteVentas" | "ContactoFinanc" | "Direccion" | "canton_id" | "Barrio" | "Tel1" | "Tel2" | "NombreContactoFactElec" | "TelContactoFactElec" | "EmailContactoFactElec" | "EmailReciboContactoFactElec" | "CantidadLineasXFactura" | "TipoEntrega" | "AceptaDevoluc" | "OrdenCompra" | "DescuentoFijo" | "PorDescuentofijo" | "DescuentoConfidencial" | "PorcDescuentoConfidencial" | "DescuentoIntroduccion" | "PorcDescuentoIntroduccion" | "PartDinamicasComerciales" | "PartEspaciosPromocionales" | "PartDisplays" | "FrecuenciaVisitaTiendas" | "AportaCodigoCABYS" | "CodigoCABYS" | "ActividadEconomicaID" | "PlazoPagoID" | "DocEntregaFacElect" | "DocEntregaGuiaDespacho" | "status";
export type ProveeSolicitantesCreationAttributes = Optional<ProveeSolicitantesAttributes, ProveeSolicitantesOptionalAttributes>;

export class ProveeSolicitantes extends Model<ProveeSolicitantesAttributes, ProveeSolicitantesCreationAttributes> implements ProveeSolicitantesAttributes {
  proveedor_id!: number;
  proveedor_dsc?: string;
  gln?: string;
  categoria_id?: number;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof ProveeSolicitantes {
    return ProveeSolicitantes.init({
    proveedor_id: {
      autoIncrement: true,
    ...
    sequelize,
    tableName: 'ProveeSolicitantes',
    schema: 'dbo',
    hasTrigger: true,
    timestamps: false,
    indexes: [
      {
        name: "PK_ProveeSolicitantes",
        unique: true,
        fields: [
          { name: "proveedor_id" },
        ]
