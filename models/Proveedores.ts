...
import type { ActividadEconomica, ActividadEconomicaId } from './ActividadEconomica';
import type { CantonDistritoProvincia, CantonDistritoProvinciaId } from './CantonDistritoProvincia';
...
export class Proveedores extends Model<ProveedoresAttributes, ProveedoresCreationAttributes> implements ProveedoresAttributes {
  ...
  // Proveedores belongsTo ActividadEconomica via ActividadEconomicaID
  ActividadEconomica!: ActividadEconomica;
  getActividadEconomica!: Sequelize.BelongsToGetAssociationMixin<ActividadEconomica>;
  setActividadEconomica!: Sequelize.BelongsToSetAssociationMixin<ActividadEconomica, ActividadEconomicaId>;
  createActividadEconomica!: Sequelize.BelongsToCreateAssociationMixin<ActividadEconomica>;
  // Proveedores belongsTo CantonDistritoProvincia via canton_id
  canton!: CantonDistritoProvincia;
  getCanton!: Sequelize.BelongsToGetAssociationMixin<CantonDistritoProvincia>;
  setCanton!: Sequelize.BelongsToSetAssociationMixin<CantonDistritoProvincia, CantonDistritoProvinciaId>;
  createCanton!: Sequelize.BelongsToCreateAssociationMixin<CantonDistritoProvincia>;
  // Proveedores belongsTo PlazosPago via PlazoPagoID
