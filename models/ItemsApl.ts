...
export interface ItemsAplAttributes {
  idNivel?: string;
  gln?: string;
  partyName?: string;
...
export class ItemsApl extends Model<ItemsAplAttributes, ItemsAplCreationAttributes> implements ItemsAplAttributes {
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof ItemsApl {
    return ItemsApl.init({
    idNivel: {
